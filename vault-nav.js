...
(function () {
  ...
  function render() {
    ...
    mount.innerHTML = `
      <header class="sticky top-0 z-40 border-b border-white/[0.08] bg-[#0b0c0f]/95">
        <div class="max-w-[1800px] mx-auto px-4 sm:px-6 min-h-16 py-2 flex flex-wrap items-center justify-between gap-3">
